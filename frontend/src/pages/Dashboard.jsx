...
const Dashboard = () => {
  ...
  const fetchContests = useCallback(async () => {
    try {
      ...
      setPastContests(newContests.filter((contest) => contest.status === 'past'));
      setPresentContests(newContests.filter((contest) => contest.status === 'present'));
      setUpcomingContests(newContests.filter((contest) => contest.status === 'future'));
